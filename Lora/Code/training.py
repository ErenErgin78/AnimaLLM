...
def setup_lora_model(model_name: str = "ytu-ce-cosmos/turkish-gpt2-medium"):
    """
...
def main():
    ...
    try:
        ...
        if torch.cuda.is_available():
            batch_size, grad_accum = 2, 16  # Turkish GPT-2 Medium için optimize edilmiş batch (effective: 32)
